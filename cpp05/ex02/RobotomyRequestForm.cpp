...
RobotomyRequestForm::RobotomyRequestForm(): AForm("RobotRequestForm", 72, 45), _target("Default")
{
    std::cout << "RobotRequestForm created with target Default " << std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(std::string target): AForm("RobotRequestForm", 72, 45), _target(target)
{
    std::cout << "RobotRequestForm created with target: " << _target << std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(RobotomyRequestForm &copy): AForm("RobotRequestForm", 72, 45), _target(copy.get_target())
{
